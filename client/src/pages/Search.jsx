...
export default function Search() {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-gray-900 text-white min-h-screen">
      {/* Sidebar */}
      <div className="p-6 border-b-2 md:border-r-2 md:min-h-screen border-gray-700">
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          {/* Search Button */}
          <button className="bg-teal-400 text-gray-900 p-3 rounded-lg uppercase font-semibold hover:bg-teal-300 transition duration-300">
            Search
          </button>
        </form>
      </div>
        ...
        <div className="p-6 flex flex-wrap gap-6">
          ...
          {showMore && (
            <button
              ...
              className="text-teal-400 hover:underline p-6 text-center w-full"
            >
              Show more
            </button>
          )}
